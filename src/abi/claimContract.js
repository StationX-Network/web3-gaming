export const claimContractAbi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_emitter", type: "address" }
    ],
    stateMutability: "nonpayable",
    type: "constructor"
  },
  { inputs: [], name: "AlreadyClaimed", type: "error" },
  { inputs: [], name: "ClaimClosed", type: "error" },
  { inputs: [], name: "ClaimLimitReached", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes", name: "_encodedData", type: "bytes" }
    ],
    name: "claim",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "address", name: "daoToken", type: "address" },
      {
        internalType: "bool",
        name: "hasAllowanceMechanism",
        type: "bool"
